...
main(anti, algorithm, model_previous_step, section, learning_timesteps, env_name, env_seed, policy_seed, noise_seed, buffer_seed,
...
To run the script from the command line, use the following command:
    python oracle.py --anti ANTI--algorithm ALGORITHM --learning_timesteps LEARNING_TIMESTEPS
...
Concrete example : 
    python oracle.py --anti TRUE --algorithm SAC --learning_timesteps 10000 
